...
import img1 from '../../../assets/image 90.png'
import img2 from '../../../assets/WhatsApp Image 2023-04-20 at 11.49 1.png'
import img3 from '../../../assets/image 92.png'
      ...
      >
        ...
        <div className="mx-auto w-[400px] rounded-2xl group relative items-center justify-center overflow-hidden cursor-pointer">         
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center  text-center translate-y-[60%] group-hover:translate-y-0 transition-all duration-500">
            <h1 className='text-white font-bold text-[20px] pr-3'>Full Stack <br />Development </h1>
          </div>
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className="mx-auto w-[400px] rounded-2xl group relative items-center justify-center overflow-hidden cursor-pointer">         
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent  group-hover:from-black/70  group-hover:to-black/70"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center  text-center translate-y-[60%] group-hover:translate-y-0 transition-all duration-500">
            <h1 className='text-white font-bold text-[20px] pr-3'>MERN Stack <br />Development </h1>
          </div>
        </div>         
        </SwiperSlide>
        <SwiperSlide>
        <div className="mx-auto w-[400px] rounded-2xl group relative items-center justify-center overflow-hidden cursor-pointer">         
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent  group-hover:from-black/70  group-hover:to-black/70"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center  text-center translate-y-[60%] group-hover:translate-y-0 transition-all duration-500">
            <h1 className='text-white font-bold text-[20px] pr-3'>Frontend <br /> Development </h1>
          </div>
        </div>
        </SwiperSlide>
        <SwiperSlide>
